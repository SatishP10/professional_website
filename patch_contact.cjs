...
export default function Contact() {
  return (
    <div className="flex flex-col min-h-screen w-full bg-[#181714] font-sans" style={{ scrollBehavior: 'smooth' }}>
      ...
      {/* Main Content Area */}
      <div className="flex-1 grid grid-cols-1 md:grid-cols-2 pt-24 pb-12 w-full max-w-7xl mx-auto relative z-10">
        
        {/* Section One (Left Half) */}
        <div className="w-full h-full flex flex-col justify-center pl-8 md:pl-20 relative z-10 py-12 md:py-0">
          
          {/* Title */}
          <h1 className="text-5xl md:text-7xl font-mono font-light tracking-[0.2em] text-white uppercase leading-tight mb-10 drop-shadow-xl">
            GET IN<br />TOUCH
          </h1>
